...
class Clock(tk.Frame):
    def __init__(self, parent):
        ...
        self.time_label = tk.Label(self, text=self.time, font=Font(family='Helvetica', size=36, weight='bold'))
        self.date_label = tk.Label(self, text=self.date, font=Font(family='Helvetica', size=27, weight='bold'))
