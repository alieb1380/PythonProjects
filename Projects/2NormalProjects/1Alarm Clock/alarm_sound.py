...
class AlarmSound():
    ...
    def on_active(self):
        if self.set_window is True:
            ...
            self.label = tk.Label(self.window, text="Beep Beep!",font=Font(family='Helvetica', size=36, weight='bold'))
            self.stop_button = tk.Button(self.window, text="Stop", command=self.stop_sound, font=Font(family='Helvetica', size=20))
